...
class CreateMedTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        guard let name = medicationNameLabel.text else {return}
        let med = MedicationController.shared.createMedication(name: name, user: user)
        ...
        MedsAlertController.shared.createAlarm(medication: med, name: name, hour: hour, minute: minute, amOrPm: amOrPm, weekdays: weekdays)
