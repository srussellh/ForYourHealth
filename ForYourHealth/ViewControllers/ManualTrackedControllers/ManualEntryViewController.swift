...
class ManualEntryViewController: UIViewController {
    ...
    var etfTopConstrant:CGFloat = 35
    var animateTime: TimeInterval = 0.01
    ...
    override func viewDidLoad() {
        ...
        let newTextfield = entryTextField.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: etfTopConstrant)
        view.addConstraint(newTextfield)
